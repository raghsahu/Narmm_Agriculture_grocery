...
public class My_order_detail_adapter extends RecyclerView.Adapter<My_order_detail_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_price,tv_pricee, tv_qty;
        ...
        public MyViewHolder(View view) {
            ...
            tv_pricee = (TextView) view.findViewById(R.id.tv_subcat_price);
    ...
    public void onBindViewHolder(My_order_detail_adapter.MyViewHolder holder, int position) {
        ...
        Glide.with(context)
                ...
                .dontAnimate()
                .into(holder.iv_img);
        holder.tv_pricee.setText(context.getResources().getString(R.string.tv_pro_price) + mList.getUnit_value() + " " +
                mList.getUnit() + " / "  + mList.getPrice()+" "+ context.getResources().getString(R.string.currency));

        holder.tv_title.setText(mList.getProduct_name());
        holder.tv_price.setText(mList.getTotal_price()+".00"+" "+context.getResources().getString(R.string.currency));
