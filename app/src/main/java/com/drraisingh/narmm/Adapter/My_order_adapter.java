...
public class My_order_adapter extends RecyclerView.Adapter<My_order_adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(My_order_adapter.MyViewHolder holder, int position) {
        ...
        holder.tv_date.setText(context.getResources().getString(R.string.date1) + mList.getOn_date());
        holder.tv_time.setText(context.getResources().getString(R.string.time1) + mList.getDelivery_time_from() + "-" + mList.getDelivery_time_to());
