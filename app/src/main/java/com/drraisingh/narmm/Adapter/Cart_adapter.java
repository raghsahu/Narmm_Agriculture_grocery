...
public class Cart_adapter extends RecyclerView.Adapter<Cart_adapter.ProductHolder> {
    ...
    public interface cartproductlistener{
        void imgcartclicklistener(String imgname);
    }

    public Cart_adapter(Activity activity, ArrayList<HashMap<String, String>> list,cartproductlistener cartproductlistener) {
        this.list = list;
    ...
    public void onBindViewHolder(final ProductHolder holder, final int position) {
        ...
        Glide.with(activity)
                ...
                .dontAnimate()
                .into(holder.iv_logo);
        holder.bind(holder.iv_logo,BaseURL.IMG_PRODUCT_URL + map.get("product_image"),listener);
        ...
        holder.tv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.tv_total.setText(" " +  (price * items));
                MediaPlayer mp;
                mp = MediaPlayer.create(activity, R.raw.shoping);
                mp.start();
        ...
        holder.iv_remove.setOnClickListener(new View.OnClickListener() {
            ...
            holder.tv_subcat_out.setVisibility(View.GONE);
    ...
    class ProductHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_price, tv_total, tv_contetiy, tv_add,tv_subcat_out,
        ...
        public ProductHolder(View view) {
          ...
          /*  tv_subcat_out = (TextView) view.findViewById(R.id.tv_subcat_out);*/
        ...
        public void bind(ImageView iv_logo, final String product_image, final cartproductlistener listener) {
            iv_logo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.imgcartclicklistener(product_image);
                }
            });
        }
    }
