...
import com.drraisingh.narmm.Adapter.Diary_adapter;
 ...
 */
public class ViewDiary_fragment extends Fragment {
    private Session_management sessionManagement;
    private String user_id;
    RecyclerView recycler_query;
    private List<DiaryList_model> delivery_address_modelList = new ArrayList<>();

    public ViewDiary_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setTitle("Diary");
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        Gson gson = new Gson();
                        Type listType = new TypeToken<List<DiaryList_model>>() {
                        }.getType();

                        delivery_address_modelList = gson.fromJson(response.getString("content"), listType);

                        // Log.e("responce_addres",delivery_address_modelList.get(0).getShop_name());
                        Diary_adapter adapter = new Diary_adapter(delivery_address_modelList,getActivity());
