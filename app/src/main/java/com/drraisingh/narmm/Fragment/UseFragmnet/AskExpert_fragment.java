 ...
 */
public class AskExpert_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_enqury, container, false);
        ((MainActivity)  getActivity()).setTitle("Ask an expert");
        ...
        tv_view_complain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment ll_complain = new ViewQuery_fragment();
    ...
    private void SubmitQuery(String et_description, String et_sub) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                GET_send_enquiry, params, new Response.Listener<JSONObject>() {
