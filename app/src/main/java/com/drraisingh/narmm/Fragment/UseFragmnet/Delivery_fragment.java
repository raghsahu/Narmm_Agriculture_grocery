...
import com.drraisingh.narmm.Fragment.Add_delivery_address_fragment;
...
public class Delivery_fragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_total, tv_item, tv_socity;
    private TextView tv_date, tv_time, tv_add_address,tv_total_amt;
    ...
    private String deli_charges,item_count;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        (getActivity()).setTitle(getResources().getString(R.string.delivery));

        tv_date = (TextView) view.findViewById(R.id.tv_deli_date);
        tv_total_amt = (TextView) view.findViewById(R.id.tv_total_amt);
       ...
       // tv_total.setText("" + db_cart.getTotalAmount());
        ...
        try {
            ...
            tv_total.setText(getArguments().getString("total_value"));
            passArray=getArguments().getString("passArray");
            item_count=getArguments().getString("item_count");
            tv_item.setText(item_count);
        }catch (Exception e){
    ...
    private void attemptOrder() {
        ...
        if (!cancel) {
            ...
            args.putString("shop_id", location_id);
            args.putString("address", address);
            args.putString("data", passArray);
            args.putString("item_count", item_count);
            args.putString("total_value", getArguments().getString("total_value"));
            args.putParcelableArrayList("cart_model", (ArrayList<? extends Parcelable>) cart_model);
            fm.setArguments(args);
            FragmentManager fragmentManager = getFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.contentPanel, fm)
                    .addToBackStack(null).commit();
     ...
     */
    private void makeGetShopRequest(String user_id) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.GET_SHOP_URL, params, new Response.Listener<JSONObject>() {
