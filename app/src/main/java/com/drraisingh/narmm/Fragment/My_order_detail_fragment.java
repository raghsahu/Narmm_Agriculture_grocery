...
import com.drraisingh.narmm.Adapter.My_order_detail_adapter;
import com.drraisingh.narmm.Config.BaseURL;
import com.drraisingh.narmm.Model.My_order_detail_model;
...
public class My_order_detail_fragment extends Fragment {
    ...
    private String sale_id,unique_id,date2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv_delivery_charge.setText("Happy Code : " + "hjghjg354554");
    ...
    private void showDeleteDialog() {
        ...
        alertDialog.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // check internet connection
                if (ConnectivityReceiver.isConnected()) {
                    makeDeleteOrderRequest(sale_id, user_id,unique_id);
                }
    ...
    private void makeGetOrderDetailRequest(String sale_id) {
        ...
        CustomVolleyJsonArrayRequest jsonObjReq = new CustomVolleyJsonArrayRequest(Request.Method.POST,
            ...
            public void onResponse(JSONArray response) {
                ...
                String inputDateStr= my_order_detail_modelList.get(0).getOn_date();
                Date date = null;
                try {
                ...
                tv_date.setText(getResources().getString(R.string.date) +outputDateStr);
     ...
     */
    private void makeDeleteOrderRequest(String sale_id, String user_id, String unique_id) {
