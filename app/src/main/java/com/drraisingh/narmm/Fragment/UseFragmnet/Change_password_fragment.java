...
public class Change_password_fragment extends Fragment {
     ...
     */
    private void makeChangePasswordRequest(final String user_id, String new_password,
        ...
        params.put("old_password", current_password);

        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.GET_change_password, params, new Response.Listener<JSONObject>() {
